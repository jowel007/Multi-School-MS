    ...
    <ul class="x-navigation">
        ...
        @if (Auth::user()->is_admin == 1 || Auth::user()->is_admin == 2)
            <li class="{{ Request::segment(2) == 'admin' ? 'active' : '' }} ">
                <a href="{{ url('panel/admin') }}"><span class="fa fa-user"></span> <span
                        class="xn-text">Admin</span></a>
            </li>

            <li class="{{ Request::segment(2) == 'school' ? 'active' : '' }} ">
                <a href="{{ url('panel/school') }}"><span class="fa fa-user"></span> <span
                        class="xn-text">School</span></a>
            </li>
        @endif
